obj/HUD
	...
	GuardBarBG
		name="Guard Meter"
		icon='GuardBarBG.png'
		desc="This meter will drain each time you block an attack.  When empty, you won't be able to Guard."
	EnemyGuardBarBG
...
var/list/KbTypes=list("DeathKB"="1:5,16:-12","StunKB"="1:21,16:-12","GuardBreakKB"="2:5,16:-12","ControlledKB"="2:21,16:-12","HomingKB"="3:5,16:-12","HealingKB"="3:21,16:-12")
